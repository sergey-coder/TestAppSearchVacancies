...
/**
 * Provides the local service interface for Vacancies. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see VacanciesLocalServiceUtil
...
public interface VacanciesLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VacanciesLocalServiceUtil} to access the vacancies local service. Add custom service methods to {@link service.service.impl.VacanciesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
